...
const UI_TEXT: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    methodologyGaugeText: "Цветные сегменты = вклады групп маркеров. Длина сегмента ∝ вклад группы.",
...
runLastCalc: "Последний расчёт",
  ...
  en: {
    ...
    methodologyGaugeText: "Colored segments = group contributions. Segment length ∝ group contribution.",
