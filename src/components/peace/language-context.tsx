...
const UI_TEXT: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    aboutOpenDataText: "Анализ 24 маркеров из 6 групп: финансы, законодательство, эскалация, военные маркеры, российская сторона, политика.",
    ...
    methodologyMarkersText: "24 маркера в 6 группах. Финансовые и законодательные маркеры имеют максимальный вес (до 12). Политические — минимальный (до 3).",
    ...
    methodologyAntiHallucinationText: "ИИ обязан ссылаться на URL источников. На сервере факты фильтруются: остаются только с URL из собранных данных.",
    methodologyGradient: "Градиент давности",
    methodologyGradientText: "Если по маркеру нет данных >14 дней, уверенность падает до LOW. Для тяжёлых маркеров (вес >8) индекс корректируется к нейтрали.",
    methodologySources: "Источники данных",
    methodologySourcesText: "IMF, MIGA, DFC, EBRD, Kiel, ISW, ACLED, Oryx, Verkhovna Rada, Prozorro, Eur-Lex, Kremlin, Reuters/AP, OSINT, Google News RSS.",
    // Поддержать
    ...
    methodologyMarkersWeightsText: "24 маркера в 6 группах. Финансовые и законодательные маркеры имеют максимальный вес (до 12). Политические — минимальный (до 3).",
    ...
    methodologyAntiHallucinationMainText: "ИИ обязан ссылаться на URL источников. На сервере факты фильтруются: остаются только с URL из собранных данных.",
    methodologyRecencyGradient: "Градиент давности",
    methodologyRecencyGradientText: "Если по маркеру нет данных >14 дней, уверенность падает до LOW. Для тяжёлых маркеров (вес >8) индекс корректируется к нейтрали.",
    methodologyDataSources: "Источники данных",
    methodologyDataSourcesText: "IMF, MIGA, DFC, EBRD, Kiel, ISW, ACLED, Oryx, Verkhovna Rada, Prozorro, Eur-Lex, Kremlin, Reuters/AP, OSINT, Google News RSS.",
...
runLastCalc: "Последний расчёт",
  ...
  en: {
    ...
    aboutOpenDataText: "Analysis of 24 markers in 6 groups: finance, legislation, escalation, military markers, Russian side, politics.",
    ...
    methodologyMarkersText: "24 markers in 6 groups. Financial and legislative markers have maximum weight (up to 12). Political — minimum (up to 3).",
    ...
    methodologyAntiHallucinationText: "AI must reference source URLs. Facts are filtered on the server: only those with URLs from collected data remain.",
    methodologyGradient: "Recency Gradient",
    methodologyGradientText: "If no data for a marker >14 days, confidence drops to LOW. For heavy markers (weight >8), the index adjusts toward neutral.",
    ...
    methodologyMarkersWeightsText: "24 markers in 6 groups. Financial and legislative markers have maximum weight (up to 12). Political — minimum (up to 3).",
    ...
    methodologyAntiHallucinationMainText: "AI must reference source URLs. Facts are filtered on the server: only those with URLs from collected data remain.",
    methodologyRecencyGradient: "Recency Gradient",
    methodologyRecencyGradientText: "If no data for a marker >14 days, confidence drops to LOW. For heavy markers (weight >8), the index adjusts toward neutral.",
