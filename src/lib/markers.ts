...
export const MARKERS: MarkerDef[] = [
  ...
  },
  {
    ...
    group: "finance",
    weight: 12,
    searchQuery: `MIGA DFC war risk insurance Ukraine long-term guarantee investment facility ${years} coverage`,
  ...
  // ===== Группа 2: Законодательство и Приватизация (Высокий вес) =====
  {
    ...
    group: "law",
    weight: 11,
    searchQuery: `Verkhovna Rada Ukraine law foreign direct investment concession investor protection ${years} adopted`,
  ...
  },
  {
    ...
    group: "law",
    weight: 9,
    searchQuery: `Ukraine concession law infrastructure foreign management port airport railway ${years}`,
  ...
  // ===== Группа 3: Сигналы риска эскалации (Высокий вес, отрицательные) =====
  {
    ...
    group: "escalation",
    weight: 10,
    searchQuery: `Belarus military mobilization conscription check military registration VUS Lukashenko ${years}`,
  ...
  },
  {
    ...
    group: "escalation",
    weight: 6,
    searchQuery: `Ukraine Poland diplomatic demarche relations tension order return dispute ${years}`,
  ...
  },
  {
    ...
    logic: "Reduced frequency/duration of air alerts and rear strikes = positive (+15 to +30). Massive wave of strikes = negative (-40 to -60).",
  ...
  },
  {
    ...
    group: "politics",
    weight: 2,
    searchQuery: `OSINT Telegram Ukraine war analysis sentiment escalation de-escalation ${years} aggregate`,
